...
{ day: 'Monday', students: 5 },
{ day: 'Tuesday', students: 10 },
{ day: 'Wednesday', students: 8 },
{ day: 'Thursday', students: 15 },
{ day: 'Friday', students: 12 },
];
...
return (
<div className="">
    <SectionTitle title="Instructor's Home" />
...
<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
  ...
  <div className="mt-8">
    <h2 className="text-xl font-bold mb-4">Student's overview</h2>
    <div className="bg-rose-50 p-4 rounded shadow">
      <ResponsiveContainer width="100%" height={300}>
        <LineChart data={lineChartData1}>
          <Line type="monotone" dataKey="students" stroke="#8884d8" strokeWidth={5} />
          <Tooltip />
          <Legend />
        </LineChart>
      </ResponsiveContainer>
